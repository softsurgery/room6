...
$(document).ready(function(){
    ...
    $(".winmaximize").click(function(){
		if ($(this).parent().parent().parent().hasClass('fullSizeWindow')) {			
			...
			$(this).parent().parent().parent().children(".wincontent").height(minimizedHeight[$(this).parent().parent().parent().attr("data-id")]);	
			$(this).parent().parent().parent().children(".wincontent").width(minimizedWidth[$(this).parent().parent().parent().attr("data-id")]);
		} else {															
			$(this).parent().parent().parent().addClass('fullSizeWindow');
			
			minimizedHeight[$(this).parent().parent().parent().attr('data-id')] = $(this).parent().parent().parent().children(".wincontent").height();
			minimizedWidth[$(this).parent().parent().parent().attr('data-id')] = $(this).parent().parent().parent().children(".wincontent").width();
